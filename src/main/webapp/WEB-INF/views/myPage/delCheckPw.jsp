...
<script>
    ...
    function submitMainForm() {
        // 사용자에게 확인을 요구
        var isConfirmed = window.confirm("정말 탈퇴 하시겠습니까?");

        // 사용자가 확인 버튼을 눌렀다면
        if (isConfirmed) {
            var form = window.opener && window.opener.document.getElementById('deleteMember');
            if (form) {
                form.submit();
