	...
	*/
	...
	//로그인 기능 구현
		...
		*/
		...
		public Map<String, Object> sign(@RequestBody MemberVO2 memberInfo) {
		    ...
		    memberInfo.setM_pwd(passwordEncoder.encode(memberInfo.getM_pwd()));
